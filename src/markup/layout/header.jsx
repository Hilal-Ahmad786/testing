...
// Images
import logo from "../../images/ods_logo_beyaz_font.png";
import logoWhite from "../../images/ods_logo_beyaz_font.png";
							...
							<div className="container clearfix">
								...
								<div className="menu-links navbar-collapse collapse justify-content-center" id="menuDropdown">
									...
									<ul className="nav navbar-nav">	
										<li className="active">
											<Link to="#">Anasayfa<i className="fa fa-chevron-down"></i></Link>
											<ul className="sub-menu">
												<li><Link to="/"><span>Home 1</span> </Link></li>
												<li><Link to="/index-2"><span>Home 2</span></Link></li>
											</ul>
										</li>
										<li className="has-mega-menu "><Link to="#">Sayfalar<i className="fa fa-chevron-down"></i></Link>
										...
										<li><Link to="#">İletişim <i className="fa fa-chevron-down"></i></Link>
											<ul className="sub-menu left">
												<li><Link to="/contact-1"><span>Contact Us 1</span></Link></li>
												<li><Link to="/contact-2"><span>Contact Us 2</span></Link></li>
											</ul>
